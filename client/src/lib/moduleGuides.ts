...
export const MODULE_GUIDES: Record<string, ModuleGuide> = {
  ...
  dark: {
    key: 'dark', title: 'Dark Security Suite', family: 'Privacy & Onion Proxy',
    mission: 'Prover perfis de alta privacidade, anonimato de rede e blindagem contra vazamento de IP.',
    scope: 'Gerenciamento de tráfego blindado, spoofing de headers e isolamento total de sessão.',
    fields: [
      { label: 'Proxy Node', meaning: 'Simulação de nó de relay e onion routing.' },
      { label: 'Cipher Suite', meaning: 'Criptografia de transporte e isolamento.' },
      { label: 'Headers', meaning: 'Sanitização rigorosa de cabeçalhos HTTP.' },
      { label: 'DNS Leak', meaning: 'Proteção contra vazamento de DNS e WebRTC.' },
    ],
    recommendedFlow: ['Configure o nível de blindagem.', 'Gere o perfil de anonimato.', 'Execute o teste de isolamento.'],
    whyDifferent: 'Focado exclusivamente em criptografia extrema, zero-logging e sanitização de rastreadores.',
    limitations: 'O anonimato absoluto depende de boas práticas operacionais do operador.',
  },
  ursa: {
